...
resource webApp1 'Microsoft.Web/sites@2021-01-01' = {
  name: 'webapponeyohannesnirayogreen'
  location: location
  properties: {
    ...
    siteConfig: {
      ...
      linuxFxVersion: 'DOCKER|hussnain786786/yohannesgreen_web1:latest'
    }
  }
}

resource webApp2 'Microsoft.Web/sites@2021-01-01' = {
  name: 'webapptwoyohannesnirayogreen'
  location: location
  properties: {
    serverFarmId: appServicePlan.id
    siteConfig: {
      ...
      linuxFxVersion: 'DOCKER|hussnain786786/yohannesgreen_web2:latest'
    }
  }
}
